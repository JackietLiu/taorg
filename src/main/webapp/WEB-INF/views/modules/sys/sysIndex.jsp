...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function() {
 		...
 		function getLogo() {
			$.get("${ctx}/sys/user/infoData",function(data){
				//alert(JSON.stringify(data));
				 if(data.ent.logoPath != "" && data.ent.logoPath !=null){
				$("#bg").css({"background":" url('"+data.ent.logoPath+"') no-repeat","background-size":"120px 60px"});
				}else{
					$("#bg").css({"background":" url('${ctxStatic }/images/trg.png') no-repeat","background-size":"120px 60px"});
				} 
			});
		}
		getLogo(); 
...
<body>
	<div id="main">
		<div id="header" class="navbar navbar-fixed-top">
		 <div class="navbar-inner" id="bg" >	 
            <%--   <div class="navbar-inner" style="background: url('${ctxStatic }/images/trg.png') no-repeat;background-size: 120px 60px;">  
 --%>				<div class="brand"><%-- <span id="productName">${fns:getConfig('productName')}</span> --%>
				 <%--  <img alt="" src="${ctxStatic }/images/trg.png" style="width:120px;height:40px;">--%>	
				</div>
 ...
 --%>					<li id="themeSwitch" class="dropdown">
				...
				<div class="nav-collapse"  style="margin-left:150px;">
	    ...
	    <div class="container-fluid">
		    ...
		    <div id="footer" class="row-fluid">
	            Copyright &copy; 2016-${fns:getConfig('copyrightYear')} ${fns:getConfig('productName')} - ${fns:getConfig('version')}
			</div>
		</div>
	</div>
	<script type="text/javascript"> 
