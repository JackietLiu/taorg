...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/taorg/registe/sysUser/">注册信息列表</a></li>
		<li class="active"><a href="${ctx}/taorg/registe/sysUser/form?id=${sysUser.id}">注册信息<shiro:hasPermission name="taorg:registe:sysUser:edit">${not empty sysUser.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="taorg:registe:sysUser:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="sysUser" action="${ctx}/taorg/registe/sysUser/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="ent" htmlEscape="false" maxlength="64" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">身份证号码：</label>
			<div class="controls">
				<form:input path="idNo" htmlEscape="false" maxlength="18" class="input-xlarge required"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="form-actions">
			<shiro:hasPermission name="taorg:registe:sysUser:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
